  ...
  const educationNews = [
    {
      ...
      date: "2026-04-19",
      source: "베리타스알파",
      link: "https://www.veritas-a.com/news/articleView.html?idxno=530516",
    },
    {
      id: "edu-news-002",
      category: "뉴스",
      title: "2027학년도 수시 비중 80.3% 역대 최고…정시 비중 사상 첫 20% 미만",
      date: "2026-04-18",
      source: "동아일보",
      link: "https://www.donga.com/news/search?query=2027+%EC%88%98%EC%8B%9C+80%25",
    },
    {
      id: "edu-news-003",
      category: "분석",
      title: "2027 대입 막차 효과…N수생 증가로 경쟁 치열해질 전망",
      date: "2026-04-15",
      source: "한국대학신문",
      link: "https://news.unn.net/news/articleView.html?idxno=562000",
    },
    {
      id: "edu-news-004",
      category: "박람회",
