...
export const ITEM_SLUG_MAP: Record<string, string> = {
  ...
  "res-010": "2026-05-01-baegam-jungang-sikdang",
  "res-011": "2026-05-01-suji-gogiri-makguksu",
  ...
  // === 신규 추가 및 기타 매핑 ===
  "yongin-youth-moving-support-2026": "2026-05-01-yongin-youth-moving-support",
